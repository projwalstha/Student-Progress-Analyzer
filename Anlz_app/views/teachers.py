...
from ..forms import BaseAnswerInlineFormSet, QuestionForm, TeacherSignUpForm,SubjectForm
...
class StudentListView(ListView):
    ...
    template_name = 'classroom/teachers/activate_students.html'
...
def approve(request, pk):
    ...
    user.is_active = True
    user.save()
    return HttpResponse('Student Account Activated')
...
class TeacherSignUpView(CreateView):
    ...
    def form_valid(self, form):
        user = form.save()
        messages.success(self.request, 'Contact admin to activate your account before logging in')
...
class QuizCreateView(CreateView):
    model = Quiz
    fields = ('name', 'subject','quiz_total_questions' )
...
class SubjectCreateView(CreateView):
    ...
    template_name = 'classroom/teachers/sub_add.html'

    def form_valid(self, form):
        subject = form.save(commit=False)
        subject.SubOwner = self.request.user
        subject.save()
        messages.success(self.request, 'The subject was added')
        return redirect('teachers:sub_list')
...
class SubjectDeleteView(DeleteView):
    ...
    template_name = 'classroom/teachers/sub_del.html'
    success_url = reverse_lazy('teachers:sub_list')

    def delete(self, request, *args, **kwargs):
        subject = self.get_object()
        messages.success(request, 'The subject %s was deleted with success!' % subject.name)
        return super().delete(request, *args, **kwargs)
...
class SubjectListView(ListView):
    ...
    def get_queryset(self):
        queryset = self.request.user.subjects
